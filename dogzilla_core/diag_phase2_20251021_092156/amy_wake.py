...
WAKE_KEYWORD  = "computer"                                 # built-in Porcupine keyword
...
def main():
    ...
    porcupine = pvporcupine.create(access_key=ACCESS_KEY, keywords=[WAKE_KEYWORD])
    ...
    say(f"Amy wake test ready. Say the word: {WAKE_KEYWORD}.")
